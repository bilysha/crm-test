...
function Account() {
	...
	const [translations, translationsLoading] = useTranslation({path: 'account', filename: 'account'});
				...
				: <>
					...
					<div className="crm-account__main">
						...
						<div className="crm-account__content-block">
							...
							<div className="crm-account__content-block__main">
								<Input uiStyle="secondary" uiSize="large" label={translations['account.section.password.current']} />
								<Input uiStyle="secondary" uiSize="large" label={translations['account.section.password.new']} />
								<Input uiStyle="secondary" uiSize="large" label={translations['account.section.password.confirm']} />
